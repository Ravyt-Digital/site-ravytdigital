      ...
      <main id="conteudo" className="services-page">
        <header className="services-hero">
          <div className="shell">
            ...
            <a className="button button-light" href="https://form.jotform.com/262255058097058" target="_blank" rel="noopener noreferrer">Solicitar diagnóstico digital <span aria-hidden="true">↗</span></a>
          </div>
        </header>
        ...
        <section className="services-cta"><div className="shell"><p>Seu próximo passo</p><h2>Descubra qual estrutura faz sentido para o seu momento.</h2><a className="button button-light" href="https://form.jotform.com/262255058097058" target="_blank" rel="noopener noreferrer">Preencher diagnóstico digital <span aria-hidden="true">↗</span></a></div></section>
