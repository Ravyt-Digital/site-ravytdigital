  ...
  return (
    <>
      ...
      <main id="conteudo" className="editorial-page">
        <header className="editorial-hero"><div className="shell"><p>Governança editorial</p><h1>Conteúdo útil começa com <em>responsabilidade.</em></h1><span>Esta política explica quem produz, como produzimos e por que publicamos os conteúdos da Ravyt Digital.</span><time dateTime="2026-08-15">Atualizada em 15 de agosto de 2026</time></div></header>
        <article className="editorial-content"><div className="shell">
          ...
          <section><span>06</span><h2>Atualizações e correções</h2><p>Atualizamos artigos quando há mudança substancial de informação, recurso, norma ou contexto. Correções relevantes podem alterar a data de modificação e serão feitas sem esconder o histórico editorial. Solicitações de revisão podem ser encaminhadas pelo atendimento da Ravyt Digital.</p></section>
          <section><span>07</span><h2>Acessibilidade e experiência</h2><p>Buscamos usar HTML semântico, hierarquia clara, textos alternativos, navegação por teclado e interfaces estáveis. A experiência deve ser compreensível por pessoas, mecanismos de busca e tecnologias assistivas — sem pop-ups que impeçam o acesso ao conteúdo principal.</p></section>
