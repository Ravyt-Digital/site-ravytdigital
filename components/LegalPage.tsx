  ...
  return (
    <main className="legal-page">
      <header className="legal-header shell">
        <a className="legal-brand" href="/" aria-label="Ravyt Digital — página inicial"><Image src="/brand/ravyt-logo-new-dark.png" alt="Ravyt Digital" width={327} height={148} priority unoptimized /></a>
