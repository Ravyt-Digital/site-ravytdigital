      ...
      <main id="conteudo" className="services-page service-landing-page">
        <header className="services-hero service-landing-hero">
          <div className="shell">
            ...
            <p>{data.lead}</p>
            <a className="button button-light" href={whatsappUrl()} target="_blank" rel="noopener noreferrer" data-track="primary_cta_click" aria-label="Quero conversar sobre meu projeto pelo WhatsApp (abre em nova aba)">QUERO CONVERSAR SOBRE MEU PROJETO <span aria-hidden="true">↗</span></a>
          </div>
        </header>
